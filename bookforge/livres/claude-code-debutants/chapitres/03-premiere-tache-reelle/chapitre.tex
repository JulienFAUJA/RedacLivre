...
\paragraphe{Cet instant vaut de l'or. L'agent a retrouvé l'exception prévue par
le projet : \code{InvalidAmount}. Tu l'avais peut-être oubliée ; lui s'aligne
dessus au lieu d'inventer un \code{ValueError} générique. C'est le bénéfice
direct de l'intention plutôt que de la micro-instruction : il a comblé un manque
de ton contexte à toi.}
